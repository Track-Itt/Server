...
const {addProduct,updateProductCount,renameProduct,changeProductCategory,addAllProducts,addAllProductsInAllInventories} = require("../controllers/productController");
